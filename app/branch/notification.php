...
<!-- header logo: style can be found in header.less -->
    ...
    <?php 
        $sql = "SELECT a.*, b.jobid as joborderid, b.branchid as branchidmo FROM notitemp a, jb_joborder b WHERE a.jobid = b.jobid AND b.branchid = '".$_SESSION['Branchid']."' AND a.branch_id = '0' ORDER BY `created_at` DESC";
        // echo $sql;
        $query = $db->ReadData($sql);
        $datetemp = "sdfsdf";
        foreach ($query as $key => $value) {
            ...
            // echo $datetemp . "--000000--". substr($value['created_at'], 0, 10);
            ...
            <li>
                ...
                <div class="timeline-item">
                    ...
                    <div class="timeline-body">
                        Job Order ID: <?php echo ucwords($value['jobid']);?>
                    </div>
                </div>
            </li>
            <?php
