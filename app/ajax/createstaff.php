...
if($request == "MC4yMTQyNzkwMCAxNDI3NzgxMDE1LTgtVlVrNTRZWXpTY240MlE5dXY0ZE1GaTFFNkJyV0o4a2Q="){
    ...
    if ( $checkerQuery ) {
        ...
        if( !$validfirstname && !$validmidname && !$validlastname && !$validnickname && !$emailQuery ) {
            ...
            $sql = "INSERT INTO `jb_user`(`username`, `password`, `email`, `name`, `firstname`, `lastname`, `midname`, `nicknake`, `address`, `contact_number`, `position`, `level`, `job_title`, `branch_id`, `status`, `created_at`) " . "VALUES ('".$username."','".$password."','".$email."','".$fullname."','".$firstname."','".$lastname."','".$midname."','".$nickname."','".$address."','".$contact."','3','3','".$jobtitle."','".$branchid."','inactive',NOW())";
