                        ...
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-grey">
                                <div class="inner">
                                    <h3>
                                        <?php 
                                            $qu2 = "SELECT a.jobid, a.soaid, a.customerid, a.branchid, a.partsid, a.technicianid, a.item, a.diagnosis, a.remarks, a.status_id,a.created_at,a.isdeleted, a.repair_status, b.customerid, b.name, c.branch_id, c.branch_name, d.tech_id, d.name as technam FROM jb_joborder a, jb_customer b, jb_branch c, jb_technicians d WHERE  (a.customerid = b.customerid AND a.branchid = c.branch_id AND a.technicianid = d.tech_id) AND a.branchid = '".$_SESSION['Branchid']."'  AND a.isdeleted = '0'  AND a.repair_status = 'Ready for Delivery' ORDER BY created_at DESC";
                                ...
                                <a href="joborders.php?type=ready_for_delivery" class="small-box-footer mlightred">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-grey">
                                <div class="inner">
                                    <h3>
                                        <?php 
                                             $qu3 = "SELECT a.jobid, a.soaid, a.customerid, a.branchid, a.partsid, a.technicianid, a.item, a.diagnosis, a.remarks, a.status_id,a.created_at,a.isdeleted, a.repair_status, b.customerid, b.name, c.branch_id, c.branch_name, d.tech_id, d.name as technam FROM jb_joborder a, jb_customer b, jb_branch c, jb_technicians d WHERE a.customerid = b.customerid AND a.branchid = c.branch_id AND a.technicianid = d.tech_id AND a.status_id = 1   AND a.branchid = '".$_SESSION['Branchid']."' AND a.repair_status = 'Waiting for SOA Approval'  AND a.isdeleted = '0'  ORDER BY created_at DESC";
                                ...
                                <a href="soa.php?type=waiting_for_soa_approval" class="small-box-footer mrorange">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-grey">
                                <div class="inner">
                                    <h3>
                                        <?php 
                                            $qu2 = "SELECT a.jobid, a.soaid, a.customerid, a.branchid, a.partsid, a.technicianid, a.item, a.diagnosis, a.remarks, a.status_id,a.created_at,a.isdeleted, a.repair_status, b.customerid, b.name, c.branch_id, c.branch_name, d.tech_id, d.name as technam FROM jb_joborder a, jb_customer b, jb_branch c, jb_technicians d WHERE  (a.customerid = b.customerid AND a.branchid = c.branch_id AND a.technicianid = d.tech_id) AND a.branchid = '".$_SESSION['Branchid']."'  AND a.isdeleted = '0'  AND a.repair_status = 'Ongoing Repair' ORDER BY created_at DESC";
                                            $query = $db->ReadData($qu2);  
                                            echo  $db->GetNumberOfRows(); 
                                        ?> 
                                    </h3>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-grey">
                                <div class="inner">
                                    <h3>
                                        <?php 
                                            $qu2 = "SELECT a.jobid, a.soaid, a.customerid, a.branchid, a.partsid, a.technicianid, a.item, a.diagnosis, a.remarks, a.status_id,a.created_at,a.isdeleted, a.repair_status, b.customerid, b.name, c.branch_id, c.branch_name, d.tech_id, d.name as technam FROM jb_joborder a, jb_customer b, jb_branch c, jb_technicians d WHERE  (a.customerid = b.customerid AND a.branchid = c.branch_id AND a.technicianid = d.tech_id) AND a.branchid = '".$_SESSION['Branchid']."'  AND a.isdeleted = '0'  AND a.done_date_delivery = '".date("y-m-d")."' ORDER BY created_at DESC";
                                            $query = $db->ReadData($qu2);  
                                            echo  $db->GetNumberOfRows(); 
                                        ?> 
                                    </h3>
                                ...
                                <a href="soa.php?type=today" class="small-box-footer mredilive">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-grey">
                                <div class="inner">
                                    <h3>
                                       <?php 
                                            ...
                                            $qu2 = "SELECT a.jobid, a.soaid, a.customerid, a.branchid, a.partsid, a.technicianid, a.item, a.diagnosis, a.remarks, a.status_id,a.created_at,a.isdeleted, a.repair_status, b.customerid, b.name, c.branch_id, c.branch_name, d.tech_id, d.name as technam FROM jb_joborder a, jb_customer b, jb_branch c, jb_technicians d WHERE  (a.customerid = b.customerid AND a.branchid = c.branch_id AND a.technicianid = d.tech_id) AND a.branchid = '".$_SESSION['Branchid']."'  AND a.isdeleted = '0'  AND a.repair_status = 'Ready for Claiming' ORDER BY created_at DESC";
                                             $query = $db->ReadData($qu2);  
                                            echo  $db->GetNumberOfRows(); 
                                        ?>
                                    </h3>
                                ...
                                <a href="soa.php?type=ready_for_claiming" class="small-box-footer mred">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-grey">
                                <div class="inner">
                                    <h3>
                                       <?php 
                                            $sql = "SELECT a.soa_id, a.jobid, a.customerid, a.branchid, a.technicianid, a.cost_id, a.status, a.conforme, a.created_at, a.updated_at, c.name, b.diagnosis, b.item, b.customerid, b.remarks, b.branchid, b.repair_status, b.parts FROM jb_soa a, jb_joborder b , jb_customer c WHERE a.branchid ='".$_SESSION['Branchid']. "' AND b.branchid  ='".$_SESSION['Branchid']. "' AND a.jobid =  b.jobid AND b.customerid = c.customerid AND b.repair_status = 'Claimed' ORDER BY a.created_at DESC";
                                            $query = $db->ReadData($sql);  
                                            echo  $db->GetNumberOfRows(); 
                                        ?>
                                    </h3>
