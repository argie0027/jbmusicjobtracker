...
if($request == "MC4yMTQyNzkwMCAxNDI3NzgxMDE1LTgtVlVrNTRZWXpTY240MlE5dXY0ZE1GaTFFNkJyV0o4a2Q="){
    ...
    $checker = "SELECT c.cat_id, c.category, c.generic, s.subcategory, s.parts_free, s.diagnostic_free FROM jb_partscat c, jb_partssubcat s WHERE c.cat_id = s.cat_id AND c.cat_id = '".$id."' ORDER BY s.subcat_id ASC";
