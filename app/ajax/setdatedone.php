...
if($request == "MC4yMTQyNzkwMCAxNDI3NzgxMDE1LTgtVlVrNTRZWXpTY240MlE5dXY0ZE1GaTFFNkJyV0o4a2Q="){
    ...
    $checker = "SELECT done_date_delivery FROM jb_joborder WHERE done_date_delivery = '".$datedelivery."' AND jobid = '".$id."'";
    ...
    if (!$checkerQuery) {
        ...
        $sql = "UPDATE jb_joborder SET done_date_delivery = '". $datedelivery . "', `updated_at` = '".dateToday()."' WHERE jobid = '".$id."'";
        ...
        $insertHistory = "INSERT INTO `jb_history`(`description`, `branch`, `name`, `branchid`, `isbranch`, `jobnumber`,`created_at`)". " VALUES ('".$description[14]."', '".$branchName."', '".$_SESSION['nicknake']."', '".$_SESSION['Branchid']."', '".$resultBranchId[0]['branchid']."', '".$id ."','".dateToday()."')";
