...
<?php
    ...
    <table class="table table-condensed" border="1">
        ...
        <tr>
            ...
            <td>
                <?php 
                $jant = "SELECT  (SUM(a.totalpartscost) + SUM(a.service_charges)+ SUM(a.total_charges)) as total FROM jb_cost a, jb_joborder b WHERE b.isdeleted = 0 ANDisdeleted = 0 AND b.jobclear = 0 AND a.jobid = b.jobid AND b.branchid  = '".$_GET['id']."' AND MONTH(b.created_at) = 10 AND YEAR(b.created_at) = '".$currtYear."' ".$range."";
                $jant  = $db->ReadData($jant);
                if($jant[0]['total'] == NULL){echo "<b>P</b> "." 0";}else{ echo "<b>P</b> ". number_format($jant[0]['total'],2);};
                ?>
            </td>
